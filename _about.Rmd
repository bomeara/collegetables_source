...
* October, 2024: Updated to Oct. 1, 2024 map on abortion restrictions from [Guttmacher Institute](https://states.guttmacher.org/policies/).
* July 15, 2024: Updated trans risk map from [Erin Reed](https://www.erininthemorning.com/p/anti-trans-legislative-risk-assessment-3dc) to be for risk for adults of anti-trans laws within the next two years (map from July 11, 2024); changed gun law stringency to use more neutral language ("A" becomes "Very high"). 
* April 7, 2024: Updated trans risk map from [Erin Reed](https://www.erininthemorning.com/p/anti-trans-legislative-risk-assessment-cd3) to be for risk for adults of anti-trans laws within the next two years (map from March 25, 2024).
...
* **Gun law stringency**: The [Giffords Law Center to Prevent Gun Violence](https://giffords.org/lawcenter/resources/scorecard/) has a score card that gives grades ("A" is very stringent, for example). As with the rest of the site, I'm trying to make this politically neutral, so I've converted their letter grades to stringency scores. Note that these are about policies at the *state* level: counties or cities may have their own laws, and institutions may create their own policies as well (for example, guns may be banned in student housing).
