...
list(
 ...
 tar_target(comparison_table, ReorderComparisonTable(AppendSourcesOfStudents(AppendTransRisk(AppendBiome(AppendAbortion(AppendGunLaws(AppendMarriageRespect(AppendContraceptiveSupport(comparison_table_slow_updating))))))))),
