...
list(
 ...
 tar_target(comparison_table_core_part1, CreateComparisonTablesPart1(ipeds_direct_and_db, exclude_no_degrees)),
 tar_target(comparison_table_core, CreateComparisonTablesPart2(comparison_table_core_part1, ipeds_direct_and_db, exclude_no_degrees)),
 tar_target(comparison_table_mountain, AppendDistanceToMountains(comparison_table_core)),
 tar_target(comparison_table_slow_updating,(AppendAAUPCensure(comparison_table_mountain))),
 tar_target(population_by_state_by_age, GetStatePopulationByAge()),
 tar_target(comparison_table_prefilter, ReorderComparisonTable(AppendPercentageFreshmenByState(AppendDiversityMetrics(AppendSourcesOfStudents(AppendBiome(comparison_table_slow_updating)))))),
